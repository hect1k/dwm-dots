...
utils=("htop" "wget" "curl" "openssh" "wireless_tools" "smartmontools" "wpa_supplicant" "iwd" "p7zip" "auto-cpufreq" "man" "man-db" "man-pages" "ripgrep" "flatpak" "linux-headers" "v4l2loopback-dkms"  "xdg-desktop-portal-gtk" "ueberzug" "xdotool" "ncdu" "mpd" "mpv" "bluez" "bluez-libs" "bluez-utils" "xclip" "xcolor" "rsync" "git" "pamixer" "playerctl" "blueman" "maim" "unzip" "zip" "brightnessctl" "ntfs-3g" "udisks2" "udiskie" "gvfs" "mlocate" "libnotify" "jq" "acpi" "sxiv" "pass" "feh" "fzf" "pipewire" "pipewire-pulse" "networkmanager" "neofetch" "picom" "xidlehook")
...
apps=("onlyoffice-bin" "yt-dlp" "silicon" "arandr" "dunst" "github-cli" "librewolf-bin" "pcmanfm" "zathura" "zathura-pdf-mupdf")
